...
public class LoadDataLayout extends FrameLayout implements View.OnClickListener {
    ...
    private void build() {
        ...
        if (builder.loadingViewLayoutId != NO_ID) {
            ...
            loadingView = LayoutInflater.from(mContext).inflate(R.layout.common_load_frame, null);
        }
        emptyView = LayoutInflater.from(mContext).inflate(R.layout.common_empty_view, null);
        errorView = LayoutInflater.from(mContext).inflate(R.layout.common_error_view, null);
        noNetworkView = LayoutInflater.from(mContext).inflate(R.layout.common_no_network_view, null);
        //findView
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == R.id.empty_layout || i == R.id.empty_reload_btn || i == R.id.error_layout || i == R.id.error_reload_btn || i == R.id.no_network_layout || i == R.id.no_network_reload_btn) {
    ...
    public static class Builder {
        ...
        int allPageBackgroundColor = R.color.window_bg;
        int allTipTextColor = R.color.load_text_color_child;
        int allTipTextSize = 16;
        int loadingTextSize = 16;
        int loadingTextColor = R.color.load_text_color_theme;
        int reloadBtnTextSize = 16;
        int reloadBtnTextColor = R.color.common_color;
