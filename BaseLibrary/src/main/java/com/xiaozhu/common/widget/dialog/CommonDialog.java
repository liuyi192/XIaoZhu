package com.xiaozhu.common.widget.dialog;
...
public abstract class CommonDialog {
    ...
    public CommonDialog showDialog(boolean isAnimation) {
        mDialogWindow.setWindowAnimations(R.style.dialog_scale_anim);
        mDialog.show();
        return this;
    }
     ...
     * 设置监听
     */
    public CommonDialog setDialogDismissListener(OnDismissListener listener) {
