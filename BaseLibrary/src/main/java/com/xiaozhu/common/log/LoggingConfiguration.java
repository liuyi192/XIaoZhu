...
public class LoggingConfiguration {
    ...
    LoggingConfiguration(Builder builder) {
    ...
    static LoggingConfiguration createDefault(Context context) {
    ...
    public static class Builder {
         ...
         *
         * @param originalHandler 原始异常处理类 {@link Thread.UncaughtExceptionHandler}
         */
        public Builder setOriginalHandler(Thread.UncaughtExceptionHandler originalHandler) {
