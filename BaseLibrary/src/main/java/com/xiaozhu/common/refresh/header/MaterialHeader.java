...
import com.xiaozhu.common.refresh.internal.CircleImageView;
import com.xiaozhu.common.refresh.internal.InternalAbstract;
import com.xiaozhu.common.refresh.internal.MaterialProgressDrawable;
...
public class MaterialHeader extends InternalAbstract implements RefreshHeader {
    ...
    public MaterialHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        thisView.setMinimumHeight(DisplayUtils.dip2px(100));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (thisView.isInEditMode() && mHeadHeight > 0) {
            ...
            circleView.layout((width / 2 - circleWidth / 2), -mCircleDiameter, (width / 2 + circleWidth / 2), circleHeight - mCircleDiameter);
        }
    }
