...
import com.xiaozhu.common.refresh.internal.ArrowDrawable;
import com.xiaozhu.common.refresh.internal.InternalClassics;
import com.xiaozhu.common.refresh.internal.ProgressDrawable;
...
public class ClassicsHeader extends InternalClassics<ClassicsHeader> implements RefreshHeader {
    ...
    public ClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final DisplayUtils density = new DisplayUtils();
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTitle)) {
            mTitleText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTitle, DisplayUtils.dip2px(16)));
        } else {
            mTitleText.setTextSize(16);
        }
        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTime)) {
            mLastUpdateText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTime, DisplayUtils.dip2px(12)));
        } else {
    ...
    public ClassicsHeader setTextTimeMarginTop(float dp) {
        ...
        lp.topMargin = DisplayUtils.dip2px(dp);
